...
proprietary [binary `.edat2` file][eprime-exts], and 2) a plain-text `.txt`
file. The rprime package provides a set of functions for parsing these `.txt`
files inside R.

[eprime-exts]: https://support.pstnet.com/hc/en-us/articles/229354727-INFO-E-Prime-file-extensions-18091 "Document about E-Prime file extensions"
